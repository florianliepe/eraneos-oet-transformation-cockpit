...
ZM-PROD-06 (Azure identity), ZM-PROD-07 (SharePoint) and ZM-PROD-08 (Teams) are explicitly deferred until they become relevant and the required platform access exists.
