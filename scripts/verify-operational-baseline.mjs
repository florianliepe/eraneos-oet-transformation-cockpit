...
const currentReleaseFile = "2026-08-12-workbench-evidence-publisher-fix.json";
...
for (const source of ["manifest.json", currentReleaseFile]) if (!controlPlane.includes(source)) errors.push(`Agent control plane is missing authoritative source ${source}.`);
