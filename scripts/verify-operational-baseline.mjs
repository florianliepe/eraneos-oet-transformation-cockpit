...
const release = read("docs/n8n/releases/2026-08-12-zm-prod-18-1.json");
...
for (const source of ["manifest.json", "2026-08-12-zm-prod-18-1.json"]) if (!controlPlane.includes(source)) errors.push(`Agent control plane is missing authoritative source ${source}.`);
